...
class AddressRepository {
  ...
  Future<dynamic> getShippingCostResponse(String shipper,shipername,  gstin,  phone, item,
      ) async {
    var post_body;
    if(item=="Other"){
      post_body = jsonEncode({
        "shipper": shipper,
        "custom_shipper_name":shipername,
        "custom_shipper_gstin":gstin,
        "custom_shipper_phone":phone
      });
    }
    else{
       post_body = jsonEncode({
