...
class CouponRepository {
  ...
  Future<CouponResponse> coupon() async {
    Uri url = Uri.parse("${AppConfig.BASE_URL}/all-coupons");
    print(url);
    ...
    print(response.body);
    print(couponResponseFromJson(response.body));
    return couponResponseFromJson(response.body);
  }
