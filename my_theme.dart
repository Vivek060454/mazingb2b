...
class MyTheme{
  ...
  static Color accent_color = Color.fromRGBO(9,78,135, 1);
  static Color accent_color_shadow = Color.fromRGBO(229,65,28, .40); // this color is a dropshadow of
  static Color soft_accent_color = Color.fromRGBO(53,141,176, 1);
  static Color splash_screen_color = Color.fromRGBO(9,78,135, 1); // if not sure , use the same color as accent color
