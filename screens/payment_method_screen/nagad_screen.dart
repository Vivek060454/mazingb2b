...
class _NagadScreenState extends State<NagadScreen> {
  ...
  getSetInitialUrl() async {
    ...
    if (nagadUrlResponse.result == false) {
      ToastComponent.showDialog(nagadUrlResponse.message.toString(), gravity: Toast.center, duration: Toast.lengthLong);
      Navigator.of(context).pop();
      return;
    }
  ...
  onPaymentSuccess(payment_details) async{
    ...
    if(nagadPaymentProcessResponse.result == false ){
      ...
      Toast.show(nagadPaymentProcessResponse.message.toString(),
          duration: Toast.lengthLong, gravity: Toast.center);
      Navigator.pop(context);
      return;
    }
