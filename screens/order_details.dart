                          ...
                          children: [
                            ...
                            _showReasonWarning
                                ? Padding(
                                    ...
                                    child: Text('Please enter reason',
                                        // AppLocalizations.of(context)
                        ...
                        ? Column(
                            ...
                            children: [
                              _orderDetails.shipping_address.name != null
                                  ? Text(
                                      "${'Order details'
                                          // AppLocalizations.of(context)!.order_details_screen_name
                              ...
                              _orderDetails.shipping_address.email != null
                                  ? Text(
                                      "${'Email'
                                          // AppLocalizations.of(context)!.order_details_screen_email
                              ...
                              Text(
                                "${'Addrese'
                                    // AppLocalizations.of(context)!.order_details_screen_address
                              ...
                              Text(
                                "${'Country'
                                    // AppLocalizations.of(context)!.order_details_screen_country
                              ...
                              Text(
                                "${'State'
                                    // AppLocalizations.of(context)!.order_details_screen_state
                                }: ${_orderDetails.shipping_address.state}",
                                maxLines: 3,
                                style: TextStyle(
                                  color: MyTheme.grey_153,
                                ),
                              ...
                              Text(
                                "${'Postal Code'
                                    // AppLocalizations.of(context)!.order_details_screen_postal_code
