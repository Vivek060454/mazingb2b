...
var varianttype;
 ...
 double opacity =0;
  ...
  fetchProductDetails() async {
    ...
    await ProductRepository().getProductDetailslogin(id: widget.id!);
...
var typeees='piece';
  ...
  onPressSendMessage() async {
    ...
    if (title == "" || message == "") {
      ToastComponent.showDialog('Title or message is empty',
          // AppLocalizations.of(context)
...
Divider(
    height: 5,
                        ...
                        // Padding(
                        //   padding:
                        //       EdgeInsets.only(top: 5, left: 14, right: 14),
                        //   child: _productDetails != null
                        //       ? buildBrandRow()
                        //       : ShimmerHelper().buildBasicShimmer(
                        //           height: 50.0,
        ...
        children: [
         ...
         cartonstatusi==false?Container():    Align(
          ...
          // ),
                        ...
                        //   child: Text('Purchased 2 Times Last Purchased on 7 Feb,2023',style: TextStyle(color: MyTheme.accent_color,fontSize: 9,fontWeight: FontWeight.w300),
                        //   ),
                        // ),
                        Divider(
                          height: 5,
...
//                                         color: Color.fromRGBO(154,195,235, 20)
//                                     ),
// width: 40,
//                                     height: 30,
//
//                                     child: Center(child: Icon(Icons.shopping_bag_outlined,size: 15,), )),
//                               ),
//                             ),
//
//
...
//                                         Text('  Buy Now  ',style: TextStyle(fontWeight: FontWeight.bold,color: Colors.white),)
//
//                                       ]),
//                                     )),
//                               ),
                ...
                SliverToBoxAdapter(
                  child: Column(
                      ...
                      children: [
                        ...
                        InkWell(
                          onTap: () {
                            if (_productDetails.videoLink == "") {
                              ToastComponent.showDialog('Video link not available',
                                  // AppLocalizations.of(context)
                            ...
                            child:Center(child: InkWell(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  SvgPicture.asset('assets/truck-moving-solid.svg',color: Colors.blue,height: 50,width:50,),
                                  Text(
                                 'Shipping Policy',
                                    style: TextStyle(
                                        color: MyTheme.font_grey,
    ...
    //     !.product_details_screen_return_policy,
                              ...
                              child: Column(
                                children: [
                                  ...
                                  SvgPicture.asset('assets/reply-solid.svg',color: Colors.blue,height: 50,width: 50,),
                                  Text('Return Policy',
                                    // AppLocalizations.of(context)
                                    //     !.product_details_screen_return_policy,
                                    style: TextStyle(
                        ...
                        //         children: [
                        //
                        //           SvgPicture.asset('assets/truck-moving-solid.svg',color: Colors.blue,height: 80,width: 80,),
                        //           Text(
                        //             AppLocalizations.of(context)
                        //                 .product_details_screen_return_policy,
                        //             style: TextStyle(
          ...
          Positioned(
            ...
            child:   InkWell(
              ...
              child: Container(
                ...
                height: 36,
                child: Center(
                  child: Icon(_isInWishList?Icons.favorite :
          ...
          Positioned(
            ...
            child:   InkWell(
              onTap: () async{
                  ...
                  var url = "https://wa.me/?text=${_productDetails.link}";
