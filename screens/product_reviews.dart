...
class _ProductReviewsState extends State<ProductReviews> {
  ...
  onTapReviewSubmit(context) async {
    ...
    //print(chatText);
    if (myReviewText == "") {
      ToastComponent.showDialog('Empty Review',
      ...
      ToastComponent.showDialog('Give rating',
            ...
            Container(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                    ...
                    // AppLocalizations.of(context)!.product_reviews_screen_type_your_review_here,
                    hintStyle: TextStyle(
