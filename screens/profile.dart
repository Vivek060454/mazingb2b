...
class _ProfileState extends State<Profile> {
  ...
  int _cartCounter = 0;
  String _cartCounterString = "0";
  int _wishlistCounter = 0;
  String _wishlistCounterString = "0";
  int _orderCounter = 0;
  String _orderCounterString = "0";
      ...
      child: Stack(
        children: [
          ...
          Container(
            ...
            // child: Image.asset(
            //   "assets/background_1.png", fit: BoxFit.cover,
            // )
          ),
          Scaffold(
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          //   ),
          //
          // // buildBottomVerticalCardListItem("assets/download.png",'All digital product',
          ...
          //   Column(
          //     children: [
          //       buildBottomVerticalCardListItem("assets/classified_product.png",'Classified ads',
          ...
          // buildBottomVerticalCardListItem("assets/shop.png",'Browse all seller',
  ...
  Widget buildHorizontalSettings() {
    return Container(
      ...
      child: Row(
        ...
        children: [
          buildHorizontalSettingItem(true, "assets/language.png",'Language'
  ...
  showLoginWarning() {
    return ToastComponent.showDialog('You need to login',
  ...
  deleteWarningDialog() {
    return showDialog(context: context, builder: (context)=>AlertDialog(
      title:Text('Are you sure you want to delete',
        // LangText(context).local.profile_screen_delete_account_warning_title,
        style:TextStyle(fontSize: 15,color: MyTheme.dark_font_grey),),
      content: Text('Delete account',
        // LangText(context).local.profile_screen_delete_account_warning_des,
        ...
        children: [
          if (wallet_system_status.$)
            Container(
              ...
              child: buildSettingAndAddonsHorizontalMenuItem("assets/wallet.png",'My Wallet'
                  // AppLocalizations.of(context)!.wallet_screen_my_wallet
                  , () {
                    Navigator.push(context, MaterialPageRoute(builder: (context) {
                      return Wallet();
          ...
          if (club_point_addon_installed.$)
            buildSettingAndAddonsHorizontalMenuItem(
                "assets/points.png",'Earned Points',
                // AppLocalizations.of(context)!.club_point_screen_earned_points,
                is_logged_in.$
                    ? () {
                  Navigator.push(context,
          ...
          if (refund_addon_installed.$)
            buildSettingAndAddonsHorizontalMenuItem(
                "assets/refund.png",'Refund Request',
                // AppLocalizations.of(context)
                //     !.refund_request_screen_refund_requests,
                is_logged_in.$
                    ? () {
          ...
          if (classified_product_status.$)
            buildSettingAndAddonsHorizontalMenuItem(
                "assets/classified_product.png",'Classified',
                // AppLocalizations.of(context)!.profile_screen_classified_products,
                is_logged_in.$
                    ? () {
                  Navigator.push(context,
