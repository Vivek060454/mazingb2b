...
print(_phone);
    ...
    print("segst"+loginResponse.toString());
    if (loginResponse.result == false) {
      ...
      ToastComponent.showDialog(loginResponse.message,
          gravity: Toast.center, duration: Toast.lengthLong);
      print("###############"+loginResponse.user!.warehouseId.toString());
      storage.setItem('warehouseid', loginResponse.user!.warehouseId.toString());
...
//                                                       child:   Text('Enter Otp',style: TextStyle(fontSize: 19,fontWeight:FontWeight.w500),),
//                                                     ),
//                                                     Pinput(
...
//               ),
              Padding(
                ...
                child: Center(
                    child: Text('Login screen or create account',
                  // AppLocalizations.of(context)
              ...
              Container(
                ...
                child: Btn.minWidthFixHeight(
                  ...
                  onPressed: () {
                    Navigator.push(context,
                        MaterialPageRoute(builder: (contallow_google_loginallow_google_loginext) {
                      return Registration();
                    }));
                  },
                ),
