...
class _AddressState extends State<Address> {
  ...
  onAddressAdd(context) async {
    ...
    if (address == "") {
      ToastComponent.showDialog('Enter addrese',
    ...
    if (_selected_country == null) {
      ToastComponent.showDialog('Select country',
  ...
  onAddressUpdate(context, index, id) async {
    ...
    if (_selected_country_list_for_update[index] == null) {
      ToastComponent.showDialog('Enter country',
          // AppLocalizations.of(context)!.address_screen_country_warning,
          gravity: Toast.center,
          duration: Toast.lengthLong);
      return;
    ...
    if (_selected_state_list_for_update[index] == null) {
      ToastComponent.showDialog('Enetr state',
          // AppLocalizations.of(context)!.address_screen_state_warning,
          gravity: Toast.center,
          duration: Toast.lengthLong);
      return;
                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: TextField(
                            ...
                            decoration: buildAddressInputDecoration(context,'Enter Addrese'
                                // AppLocalizations.of(context)!.address_screen_enter_address
                            ),
                          ),
                        ),
                      ),
                        ...
                        child: Container(
                          ...
                          child: TypeAheadField(
                            ...
                            textFieldConfiguration: TextFieldConfiguration(
                              ...
                              decoration: buildAddressInputDecoration(context,'Enter country'
                                  // AppLocalizations.of(context)
                        ...
                        child: Container(
                          ...
                          child: TypeAheadField(
                            ...
                            textFieldConfiguration: TextFieldConfiguration(
                              ...
                              decoration: buildAddressInputDecoration(context,'Enter state'
                                  // AppLocalizations.of(context)
                        ...
                        child: Container(
                          ...
                          child: TypeAheadField(
                            ...
                            textFieldConfiguration: TextFieldConfiguration(
                              ...
                              decoration: buildAddressInputDecoration(context,'Enter city'
                                  // AppLocalizations.of(context)
                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: TextField(
                            ...
                            autofocus: false,
                            decoration: buildAddressInputDecoration(context,'Enter Postal code'
                                // AppLocalizations.of(context)
                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: TextField(
                            ...
                            autofocus: false,
                            decoration: buildAddressInputDecoration(context,'Enter phone number'
                                // AppLocalizations.of(context)
                          ...
                          child: TypeAheadField(
                            ...
                            noItemsFoundBuilder: (context) {
                              return Container(
                                height: 50,
                                child: Center(
                                    child: Text('No availabvle country',
                                        // AppLocalizations.of(context)
                                        //     !.address_screen_no_country_available,
                                        style: TextStyle(
                                            color: MyTheme.medium_grey))),
                        ...
                        child: Container(
                          ...
                          child: TypeAheadField(
                            ...
                            textFieldConfiguration: TextFieldConfiguration(
                              ...
                              decoration: buildAddressInputDecoration(context,'Enetr city'
                                  // AppLocalizations.of(context)
                                  // !.address_screen_enter_city
                              ),
                            ),
                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: TextField(
                            ...
                            autofocus: false,
                            decoration: buildAddressInputDecoration(context,'Enter phone'
                                // AppLocalizations.of(context)
                                // !.address_screen_enter_phone
                            ),
                          ),
    ...
    return AppBar(
      ...
      title: Column(
        ...
        children: [
          ...
          Text(
            "* ${'Double tab on an address to make it default'
  ...
  buildAddressList() {
    ...
    if (is_logged_in == false) {
      return Container(
          height: 100,
          child: Center(
              child: Text('login to view addrese',
      ...
      return Container(
          height: 100,
          child: Center(
              child: Text('No addresses is added',
            // AppLocalizations.of(context)!.common_no_address_added,
            style: TextStyle(color: MyTheme.font_grey),
          )));
    }
      ...
      child: BottomAppBar(
        child: Container(
          ...
          Btn.minWidthFixHeight(
                ...
                child: Text('Back to shipping info',
                  // AppLocalizations.of(context)
      ...
      child: PopupMenuButton<MenuOptions>(
        ...
        itemBuilder: (BuildContext context) => <PopupMenuEntry<MenuOptions>>[
          PopupMenuItem<MenuOptions>(
            ...
            child: Text('Edit'
                // AppLocalizations.of(context)!.address_screen_edit
            ),
          ),
          PopupMenuItem<MenuOptions>(
            value: MenuOptions.Delete,
            child: Text('Delete'
                // AppLocalizations.of(context)!.address_screen_delete
            ),
          ),
          PopupMenuItem<MenuOptions>(
            ...
            child:
                Text('Add location'
                    // AppLocalizations.of(context)!.address_screen_add_location
                ),
          ),
        ],
      ),
