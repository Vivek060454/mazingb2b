...
class _PasswordOtpState extends State<PasswordOtp> {
  ...
  onPressConfirm() async {
    ...
    if (code == "") {
      ToastComponent.showDialog('Code is Empty',
      ...
      ToastComponent.showDialog('Confirm password',
      ...
      ToastComponent.showDialog('Password should be alteat 6 letter',
          // AppLocalizations.of(context)!
      ...
      ToastComponent.showDialog('Password not match',
          // AppLocalizations.of(context)!
