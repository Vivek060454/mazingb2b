...
class _FilterState extends State<Filter> {
  ...
  fetchProductData() async {
    print("sc:"+_searchKey.toString());
    print("sb:"+ widget.serachkey.toString());
    if( widget.serachkey!=''){
      var productResponse = await ProductRepository().getFilteredProducts(
          page: _productPage,
          name: widget.serachkey,
...
else{  var productResponse = await ProductRepository().getFilteredProducts(
        page: _productPage,
        name: _searchKey,
        sort_key: _selectedSort,
        brands: _selectedBrands.join(",").toString(),
        ...
        GestureDetector(
          onTap: () {
            _selectedFilter!.option_key == "product"
                ...
                : ToastComponent.showDialog(
                'Use can use filter bu searching product',
                gravity: Toast.center,
                duration: Toast.lengthLong);
          },
          child: Container(
              ...
              child: Padding(
                  ...
                  child: TypeAheadField(
                    ...
                    itemBuilder: (context, dynamic suggestion) {
                      ...
                      var subtitle =
                          "${'Searching'} ${suggestion.count} ${'Searching for low'}";
                      if (suggestion.type != "search") {
                        subtitle =
                        "${suggestion.type_string} ${'Found all'}";
                      }
                      return ListTile(
                        dense: true,
                        title: Text(
