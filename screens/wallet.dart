...
class _WalletState extends State<Wallet> {
  ...
  onPressProceed(){
    ...
    if(amount_String == ""){
      ToastComponent.showDialog('Plese check amount',
    ...
    Navigator.push(context, MaterialPageRoute(builder: (context) {
      return Checkout(paymentFor: PaymentFor.WalletRecharge,rechargeAmount: amount,title:'Recharge wallet'
  ...
  buildRechargeList() {
    if (_rechargeListInit && _rechargeList.length == 0) {
      ...
      return Center(child: Text( 'No recharge'
                            ...
                            child: TextField(
                              ...
                              decoration: InputDecoration(
                                fillColor: MyTheme.light_grey,
                                  ...
                                  // AppLocalizations.of(context)!.wallet_screen_enter_amount,
                                  hintStyle: TextStyle(
                                      fontSize: 12.0,
