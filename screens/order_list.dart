  ...
  static List<PaymentStatus> getPaymentStatusList() {
    return <PaymentStatus>[
      PaymentStatus('','All payments'
          // AppLocalizations.of(OneContext().context!)!.order_list_screen_all_payments
    ),
...
class DeliveryStatus {
  ...
  static List<DeliveryStatus> getDeliveryStatusList() {
    return <DeliveryStatus>[
      DeliveryStatus('', 'All deliveries'
          // AppLocalizations.of(OneContext().context!)!.order_list_screen_all_deliveries
      ),
      DeliveryStatus('confirmed', 'Confirmed'
          // AppLocalizations.of(OneContext().context!)!.order_list_screen_confirmed
      ),
      DeliveryStatus('on_delivery','Delivey'
          // AppLocalizations.of(OneContext().context!)!.order_list_screen_on_delivery
      ),
      DeliveryStatus('delivered', 'Delivered'
          // AppLocalizations.of(OneContext().context!)!.order_list_screen_delivered
      ),
    ];
  }
}
...
class _OrderListState extends State<OrderList> {
  ...
  buildOrderListList() {
    if (_isInitial && _orderList.length == 0) {
      ...
      return Center(child: Text('No more product'
