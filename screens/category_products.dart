...
class CategoryProducts extends StatefulWidget {
  CategoryProducts({Key? key,  this.category_name, this.variants,  this.category_id})
      : super(key: key);
...
class _CategoryProductsState extends State<CategoryProducts> {
  ...
  fetchData() async {
    var productResponse = await ProductRepository().getCategoryProducts(
        id: widget.category_id!, page: _page, name: _searchKey ,catego:widget.variants);
    _productList.addAll(productResponse.products as Iterable);
    print("re"+_productList.toString());
    _isInitial = false;
  ...
  AppBar buildAppBar(BuildContext context) {
    return AppBar(
      ...
      flexibleSpace: Container(
        ...
        child: Image.asset(
          "assets/background_1.png",width: DeviceInfo(context).width,fit: BoxFit.fill,
        ),
      ),
